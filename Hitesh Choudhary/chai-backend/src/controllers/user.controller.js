...
const refreshAccessToken = asyncHandler(async(req, res) => {
    ...
    return res
    .status(200)
    .cookie("accessToken", actionToken, options)
    .cookie("refreshToken", refreshToken, options)
    .json(
        new ApiResponse(200, 
...
const changeCurrentPassword = asyncHandler(async(req, res) => {
    ...
    user.password = newPassword; // will be hashed by "pre" middleware
    await user.save();
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    if(!avatar || !avatar?.url) {
        throw new ApiError(400, "Error while updating an avatar");
    }
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    if(!coverImage || !coverImage?.url) {
        throw new ApiError(400, "Error while updating an cover image");
    }
